...
class Event_MCP(unittest.TestCase):
    ...
    def test_event(self):
        ...
        driver.get("http://midcityproject.pythonanywhere.com/")
        time.sleep(5)
        elem = driver.find_element_by_xpath("/html/body/div[2]/div[3]/a").click() #view all events
        driver.get("http://midcityproject.pythonanywhere.com/events/")
        time.sleep(8)
        elem = driver.find_element_by_xpath("/html/body/div[2]/div/div[7]/div/div[2]/a[2]").click() #event signup
        time.sleep(5)
        elem = driver.find_element_by_xpath("/html/body/form/button").click()#save button
        time.sleep(5)
        def tearDown(self):
            self.driver.close()
